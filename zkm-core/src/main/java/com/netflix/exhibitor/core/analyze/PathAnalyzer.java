...
public class PathAnalyzer {
    ...
    private static final Comparator<String> childComparator = (p1, p2) -> {
    ...
    /**
     * Perform the analysis and return the results. Always check {@link com.netflix.exhibitor.core.analyze.Analysis#getError()}
